            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <p class="text-gray-600 mb-8">
                        {{ __('Join us today! Fill in your details to get started.') }}
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="name" name="name" type="text" autocomplete="name" required 
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 @error('name') border-red-500 @enderror"
            ...
            <div class="absolute inset-0 gradient-bg">
                <div class="flex items-center justify-center h-full">
                    <div class="text-center text-white px-12">
                        ...
                        <p class="text-xl opacity-90">{{ __('Join Our Community') }}</p>
                        <p class="mt-4 opacity-80">{{ __('Start your educational journey with us') }}</p>
                    </div>
                </div>
            </div>
        </div>
