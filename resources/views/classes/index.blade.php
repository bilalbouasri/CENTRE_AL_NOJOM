...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-xl hover:scale-105">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800">
            <div class="flex items-center justify-between">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">All Classes</h3>
                <span class="text-sm text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-600 px-3 py-1 rounded-full">
                           ...
                           <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-200 group">
                                        ...
                                        <div class="ltr:ml-4 rtl:mr-4">
                                            ...
                                            @if(!empty($class->grade_levels))
                                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                                    Grades: {{ implode(', ', $class->grade_levels) }}
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3 text-sm font-medium text-gray-900 dark:text-white">
                                            {{ $class->teacher->first_name }} {{ $class->teacher->last_name }}
                                        </div>
                                    </div>
                                </td>
                                 <td class="px-6 py-4 whitespace-nowrap">
                                     <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
                                 ...
                                 <td class="px-6 py-4 whitespace-nowrap">
                                     <div class="flex items-center">
                                         ...
                                         <span class="text-xs text-gray-500 dark:text-gray-400 ltr:ml-1 rtl:mr-1">students</span>
                                     </div>
                                 </td>
                                 <td class="px-6 py-4 whitespace-nowrap">
                                 ...
                                 <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                     <div class="flex items-center space-x-3">
                                         <a href="{{ route('classes.show', $class) }}"
                                            class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-200 p-2 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20"
                                            title="View Class">
                                         ...
                                         <a href="{{ route('classes.edit', $class) }}"
                                            class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors duration-200 p-2 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/20"
                                            title="Edit Class">
                                             <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                         ...
                                         <form action="{{ route('classes.destroy', $class) }}" method="POST" class="inline">
                                             ...
                                             @method('DELETE')
                                             <button type="submit"
                                                     class="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 transition-colors duration-200 p-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20"
                                                     title="Delete Class"
